...
public final class DrawImageWithLocationSizeAndObserverEvent extends DrawImageEvent {
	...
	public void paintWithImage(Graphics2D g, Image image) {
		...
		if(image == null)
			drawPlaceholder(g, "image " + getImageID(), getX(), getY(), getWidth(), getHeight(), null);
		else
	...
	public long getObserver() { return getLong(6); }
	
	public String getHumanReadableName() { return "scaled image"; }

	public String toString() { return super.toString() + "\tdrawImageWithLocationSizeAndObserver " + getImage() + " " + getX() + " " + getY() + " " + getObserver(); }
