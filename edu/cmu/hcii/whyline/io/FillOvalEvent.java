 ...
 *
 */
public final class FillOvalEvent extends RenderEvent {
	...
	public FillOvalEvent(Trace trace, int eventID) {
	...
	public String getHumanReadableName() { return "filled oval"; }

	public boolean canOcclude() { return true; }

	public String toString() { return super.toString() + getGraphicsID() + "\tfillOval " + getX() + " " + getY() + " " + getWidth() + " " + getHeight(); }
